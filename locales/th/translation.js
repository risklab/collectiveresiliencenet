export let locales_th = [{
  intro: {
    header: "",
    title: "THBuilding Resilience Collectively",
    subTitle: "THDeveloping methods, technologies and prototypes to embed risk reduction and preparedness into the design of cities to increase local community resilience.",
    aboutbtn: "THMore about us",
